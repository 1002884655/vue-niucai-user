<template>
  <div class="Page">
    <MainPageContainer :GoBack="() => { $router.replace({ name: 'DaLeTou' }) }" :ShowMainHeader="true" :ShowMainHeaderBack="true" MainHeaderTitle="大乐透">
          ...
          <div>
            ...
            <div class="OtherTab">
              <div>
                ...
                <div class="flex-h">
                  <span class="flex-item">是否追加？</span>
                  <!-- <span>追号喜中二等奖</span> -->
